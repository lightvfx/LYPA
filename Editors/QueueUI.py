...
# Form implementation generated from reading ui file 'QueueViewer.ui'
#
# Created: Mon Dec 12 22:26:03 2011
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.list.headerItem().setText(0, QtGui.QApplication.translate("Form", "Task", None, QtGui.QApplication.UnicodeUTF8))
        self.list.headerItem().setText(1, QtGui.QApplication.translate("Form", "Type", None, QtGui.QApplication.UnicodeUTF8))
        self.list.headerItem().setText(2, QtGui.QApplication.translate("Form", "Status", None, QtGui.QApplication.UnicodeUTF8))
        self.list.headerItem().setText(3, QtGui.QApplication.translate("Form", "user", None, QtGui.QApplication.UnicodeUTF8))
        self.list.headerItem().setText(4, QtGui.QApplication.translate("Form", "PID", None, QtGui.QApplication.UnicodeUTF8))
