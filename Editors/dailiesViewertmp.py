...
class dailiesViewer(QtGui.QWidget):
    ...
    def _PrintAllEventsOnDefaultCalendar(self):
        ...
        a = []
        feed = self.cal_client.GetCalendarEventFeed("http://www.google.com/calendar/feeds/8lglqkn2teder5d3ek4fuku0a0@group.calendar.google.com/private/full")
    ...
    def refreshCal(self):
        ...
        self.cal_client.ClientLogin('antoine.moulineau@gmail.com', 'Royan1980', self.cal_client.source);
...
class DailiesList(QtGui.QWidget):
    def __init__(self):
        ...
        self.labels = []
        self.pixmaps = []
        self.size = self.gridLayout.geometry()
    ...
    def redrawThb(self):
        self.Hcount = int(float(self.size.width()) /float(self.Res + 25))
        col = 0
        row = 0
        id = 0
